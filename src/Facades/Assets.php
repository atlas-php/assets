 ...
 * @method static EloquentCollection listForModel(\Illuminate\Database\Eloquent\Model $model, array $filters = [])
 * @method static EloquentCollection listForUser(int|string $userId, array $filters = [])
